...
$prize = mysqli_query($conn, "SELECT * FROM event WHERE EVENTS!='$sympName' AND STATUS='OPEN'");
...
?>
    ...
    <head>
        ...
        <title>Prize Select - Admin</title>
    ...
    <body class="admin-panel">
        ...
        <div class="wrapper">
            ...
            if (isset($_GET["msg"]) && $_GET["msg"] == "send") {
                echo "<span id='sucMsg'>All mails successfully sent</span><br>";
            } else if (isset($_GET["msg"]) && $_GET["msg"] == "notSend" && isset($_GET['id'])) {
                echo "<span id='errMsg'>Mail not send to {$_GET['id']}</span><br>";
            }
            ?>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                window.setTimeout(function() {
                    $(".navigation-admin > ul > li.prize").addClass("active");
                }, 700);
            });
        </script>
    </body>
